...
from tables import Users, Membercode, Preregi
...
class Final(Resource):
	...
	def post(self):
		...
		regi = Users(firstname=fname, lastname=lname, fullname=fname+' '+lname, birthday=bday, mobile=mob, email=check.email, password=password)
		db.session.add(regi)
...
class Ask(Resource):
	...
	def post(self):
		...
		sender1 = "%s <%s>" %(mail.fullname, mail.email)
		recipient = "Healthy Options <basyc2014@gmail.com>"
